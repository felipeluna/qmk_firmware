...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT_split_3x5_3(
        KC_LCBR, KC_AMPR, KC_ASTR, KC_LPRN, KC_RCBR,        KC_UNDS, KC_GRV,  KC_COLN, KC_SCLN, KC_ENT,
        KC_COLN, KC_DLR , KC_PERC, KC_CIRC, KC_PLUS,        KC_MINS, OS_SHFT, OS_CTRL, OS_ALT,  OS_CMD,
        KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE,        KC_EQL,  KC_LBRC, KC_RBRC, KC_ENT,  KC_BSLS,
                          KC_LPRN, KC_RPRN, KC_QUES,        _______, _______, _______
    ),
